...
export function DashboardMaintenancePage() {
  ...
  const canWriteDashboard = hasPermission("dashboard:write") && canMaintainDashboard;
  ...
  if (!canReadDashboard || !canMaintainDashboard) {
    return (
      <div className="space-y-4">
        <h1 className="text-2xl font-semibold tracking-normal text-slate-950">看板维护</h1>
        <Card>
